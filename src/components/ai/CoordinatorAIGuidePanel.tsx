...
import { Sparkles, CheckCircle2, FileText, ChevronRight, Wand2, Search, Info } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-slate-50 border-l border-slate-200 shadow-inner">
      <div className="p-4 border-b border-slate-200 bg-white">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            <h3 className="font-black text-slate-800 text-sm tracking-tight text-blue-800">Guía IA del Coordinador</h3>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Asesoría Técnica CACES</p>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {isGenerating ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center space-y-3 opacity-50 grayscale">
              ...
              <div>
                <p className="text-sm font-bold text-slate-600">¿Necesitas ayuda técnica?</p>
