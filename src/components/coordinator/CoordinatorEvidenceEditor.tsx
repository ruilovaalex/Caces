                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-600 leading-relaxed">
                    {evaluatorMode
                      ...
                      : 'Elige una plantilla o empieza en blanco, redacta seccion por seccion, usa la IA cuando sea necesario, revisa la vista previa y descarga el documento institucional.'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <p className="mt-1 text-xs text-slate-400">
                  {evaluatorMode
                    ? 'La revision depende de la version subida por el coordinador.'
                    : 'El avance se centra en el borrador, la vista previa y el documento institucional generado.'}
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <p className="mt-2 truncate text-sm font-bold text-slate-700">
                  {evaluatorMode
                    ...
                    : (generatedDocument?.fileName || 'SIG-EV-...')}
                </p>
                <p className="mt-1 text-xs text-slate-400">
                  {evaluatorMode
                    ? (currentFile ? `Ultima carga: ${currentFile.uploadDate}` : 'Cuando se cargue una version, aparecera aqui.')
                    : 'La descarga conserva el nombre institucional generado por la app.'}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-1">
              <p className="text-xs text-slate-500 leading-relaxed">
                {evaluatorMode
                  ...
                  : 'Este flujo genera y guarda un documento institucional descargable desde el editor.'}
              </p>
